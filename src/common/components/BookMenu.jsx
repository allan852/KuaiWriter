      ...
      <ul className={style.menu}>
        ...
        <li className={style.menu_item}>
          <Tooltip title="人物" placement="right">
            <NavLink to={`${match.url}/characters`} activeClassName={style.active}>
        ...
        <li className={style.menu_item}>
          <Tooltip title="地点" placement="right">
            <NavLink to={`${match.url}/locations`} activeClassName={style.active}>
        ...
        <li className={style.menu_item}>
          <Tooltip title="地图" placement="right">
            <NavLink to={`${match.url}/maps`} activeClassName={style.active}>
        ...
        <li className={style.menu_item}>
          <Tooltip title="大纲" placement="right">
            <NavLink to={`${match.url}/mindmaps`} activeClassName={style.active}>
        ...
        <li className={style.menu_item}>
          <Tooltip title="书籍" placement="right">
            <NavLink to={`${match.url}/info`} activeClassName={style.active}>
